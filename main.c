...
int main(void)
{
  ...
  MX_GPIO_Init();
  /* USER CODE BEGIN 2 */
  //Zagon LCD-ja in ustvarjanje znaka
  TM_HD44780_Init(16, 2);  //1. št. znakov v vrstici, 2. št. vrstic
  ...
  //Izpis vrednosti spremenljivke val
  TM_HD44780_Puts(0, 1, "Val= ");
  itoa(val, beseda, 10); //(int, string, numerical type: 2, 8, 10, 16)
  TM_HD44780_Puts(5, 1, beseda);

  //Zakasnitev, brisanje podatkov in aktivacija utripanja kurzorja
  HAL_Delay(2000);
  TM_HD44780_Clear();
  TM_HD44780_BlinkOn();
